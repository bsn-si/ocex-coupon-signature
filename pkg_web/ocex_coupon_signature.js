...
* @returns {string}
*/
export function get_coupon_signature(contract_address_hex, receiver_address_hex, coupon_secret_hex) {
    try {
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('ocex_coupon_signature_bg.wasm', import.meta.url);
    }
    const imports = {};
    imports.wbg = {};
